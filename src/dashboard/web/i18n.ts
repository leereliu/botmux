...
const zh: DashboardMessages = {
  ...
  'botDefaults.sectionRole': '团队角色',
  'botDefaults.roleHelp': '该 bot 跨群的默认人设（团队级角色），会注入到该 bot 在各群的会话里；单个群可在「角色」页单独覆盖。留空保存＝删除。',
...
const en: DashboardMessages = {
  ...
  'botDefaults.sectionRole': 'Team Role',
  'botDefaults.roleHelp': 'This bot\'s cross-chat default persona (team-level role), injected into the bot\'s sessions in every chat; a single group can override it on the Roles page. Save empty = delete.',
